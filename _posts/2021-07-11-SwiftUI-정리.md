...
categories:
  - iOS
  - SwiftUI
last_modified_at: 2021-08-10 00:30:00
...
struct ContentView: View {
    @State private var name = "zdo"
    
    var body: some View {
        Text(name) // "zdo"를 출력합니다.
    }
}
```

State 프로퍼티와 뷰와 연결하기 위해서는 $ 기호를 사용해 바인딩해야 합니다. 바인딩을 하면 뷰에서 발생한 이벤트에 의해 State 프로퍼티의 값을 변경할 수 있습니다.
...
State 프로퍼티를 외부에 참조를 전달하기 위해서는 $ 기호를 사용해야 합니다. 외부의 Binding 프로퍼티에 참조를 전달할 수 있습니다.
